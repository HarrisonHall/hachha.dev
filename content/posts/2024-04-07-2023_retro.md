+++
name = "2023 Retrospective & 2024 Goals"
blurb = "Dropping out of school, failing the N3, fitness, theming, and optimization"
date = "2024-04-07"
article = "2023_retro"
tags = ["life", "dev", "jp"]
+++
...
them and reevaluate what I plan to achieve by the end of the year.
...
corpus of preconfigured application themes.
...
![server](/blog/media/server.png)

So far, I'm really pleased. Installing Ubuntu server was a breeze (I'll use nix
and podman to run any necessary services) and everything sort-of just works. No
complaints.
